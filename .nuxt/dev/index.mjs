...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, getRequestURL, getResponseHeader, getResponseStatus, createError, getQuery as getQuery$1, getRouterParam, readBody, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getResponseStatusText } from 'file:///Users/spider/Downloads/SWIFTZONE/WebSite/swiftzone/node_modules/h3/dist/index.mjs';
...
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/spider/Downloads/SWIFTZONE/WebSite/swiftzone/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import destr from 'file:///Users/spider/Downloads/SWIFTZONE/WebSite/swiftzone/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file:///Users/spider/Downloads/SWIFTZONE/WebSite/swiftzone/node_modules/ufo/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/spider/Downloads/SWIFTZONE/WebSite/swiftzone/node_modules/unhead/dist/server.mjs';
import { isVNode, toValue, isRef } from 'file:///Users/spider/Downloads/SWIFTZONE/WebSite/swiftzone/node_modules/vue/index.mjs';
import { walkResolver } from 'file:///Users/spider/Downloads/SWIFTZONE/WebSite/swiftzone/node_modules/unhead/dist/utils.mjs';
import { renderToString } from 'file:///Users/spider/Downloads/SWIFTZONE/WebSite/swiftzone/node_modules/vue/server-renderer/index.mjs';
...
import { createStorage, prefixStorage } from 'file:///Users/spider/Downloads/SWIFTZONE/WebSite/swiftzone/node_modules/unstorage/dist/index.mjs';
...
import consola, { consola as consola$1 } from 'file:///Users/spider/Downloads/SWIFTZONE/WebSite/swiftzone/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/spider/Downloads/SWIFTZONE/WebSite/swiftzone/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/spider/Downloads/SWIFTZONE/WebSite/swiftzone/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/spider/Downloads/SWIFTZONE/WebSite/swiftzone/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/spider/Downloads/SWIFTZONE/WebSite/swiftzone/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/spider/Downloads/SWIFTZONE/WebSite/swiftzone/node_modules/errx/dist/index.js';
import { basename, isAbsolute } from 'file:///Users/spider/Downloads/SWIFTZONE/WebSite/swiftzone/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file:///Users/spider/Downloads/SWIFTZONE/WebSite/swiftzone/node_modules/@iconify/utils/lib/index.mjs';
import { collections } from 'file:///Users/spider/Downloads/SWIFTZONE/WebSite/swiftzone/.nuxt/nuxt-icon-server-bundle.mjs';
...
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///Users/spider/Downloads/SWIFTZONE/WebSite/swiftzone/node_modules/unhead/dist/plugins.mjs';
...
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/spider/Downloads/SWIFTZONE/WebSite/swiftzone/.data/kv"}));
...
const _0ehRwJdcrXMMRZeEz1izsRePTYqroUEQ5wI7BRUYGvs = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/spider/Downloads/SWIFTZONE/WebSite/swiftzone";
...
const _b09wR9johg3feghxIhUE9ZN0Y810DAlxZ_oFcUyJkZU = (nitroApp) => {
...
const plugins = [
  _0ehRwJdcrXMMRZeEz1izsRePTYqroUEQ5wI7BRUYGvs,
_b09wR9johg3feghxIhUE9ZN0Y810DAlxZ_oFcUyJkZU
];
...
const _dTiX11 = eventHandler(async (event) => {
  ...
  return await import('file:///Users/spider/Downloads/SWIFTZONE/WebSite/swiftzone/.nuxt/content/database.compressed.mjs').then((m) => m[collection]);
});
...
const _lazy_fYvStn = () => Promise.resolve().then(function () { return sendEmail$1; });
const _lazy_uZUEk_ = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/send-email', handler: _lazy_fYvStn, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_uZUEk_, lazy: true, middleware: false, method: undefined },
...
const getClientManifest = () => import('file:///Users/spider/Downloads/SWIFTZONE/WebSite/swiftzone/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/spider/Downloads/SWIFTZONE/WebSite/swiftzone/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
